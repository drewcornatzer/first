...
void fillWith( vector <int> &assignments, int scores)
{
    for(int num=0;num<assignments.size();num++)
    {
        assignments[num]=scores;
    }
}
void printVector(vector <int> assignments)
{
    for(int num=0;num<assignments.size();num++)
    {
        cout<<assignments[num]<<" ";
    }
}
